      ...
      devShells = foreachSystem ({ pkgs, final }: {
        default = final.tectonic-unwrapped.overrideAttrs ({ nativeBuildInputs, ... }: {
          ...
          nativeBuildInputs = with pkgs.buildPackages; [
            ...
            ++ lib.optional stdenv.buildPlatform.isLinux mold-wrapped # fast linker for development
          ;
          ...
          env = {
            ...
            CARGO_BUILD_RUSTFLAGS = lib.optionalString pkgs.stdenv.buildPlatform.isLinux ''
